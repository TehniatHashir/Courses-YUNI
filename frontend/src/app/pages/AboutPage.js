...
export function AboutPage() {
  ...
  const styles = {
    ...
    section: { padding: isMobile ? "3rem 1rem" : "5rem 2rem" },
    container: { maxWidth: "1200px", margin: "0 auto" },
    sectionTitle: {
      fontSize: isMobile ? "clamp(1.75rem, 5vw, 2.5rem)" : "2.5rem",
      fontWeight: "bold",
      marginBottom: "2rem",
      color: "#ffffff",
      textAlign: "center"
    ...
    cardIcon: { fontSize: isMobile ? "2.5rem" : "3.5rem", marginBottom: "1rem", display: "block" },
    cardTitle: { fontSize: isMobile ? "1.1rem" : "1.3rem", fontWeight: "bold", marginBottom: "0.8rem", color: "#333" },
    cardText: { color: "#666", lineHeight: "1.6", fontSize: isMobile ? "0.9rem" : "1rem" },
    story: { background: "transparent", padding: isMobile ? "3rem 1rem" : "5rem 2rem" },
    storyContent: {
      maxWidth: "800px",
      margin: "0 auto",
      lineHeight: "1.8",
    ...
    team: { padding: isMobile ? "3rem 1rem" : "5rem 2rem" },
    teamGrid: {
      display: "grid",
      gridTemplateColumns: isMobile ? "1fr" : "repeat(auto-fit, minmax(250px, 1fr))",
    ...
    memberName: { fontSize: isMobile ? "1.1rem" : "1.3rem", fontWeight: "bold", marginBottom: "0.5rem", color: "#ffffff" },
    memberRole: { color: "#ffffff", marginBottom: "1rem", fontWeight: 500, fontSize: isMobile ? "0.9rem" : "1rem" },
    memberBio: { color: "#ffffff", fontSize: isMobile ? "0.85rem" : "0.95rem", lineHeight: "1.5" },
  };
